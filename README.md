...
Done - 1. Open the project in Visual Studio Code. 
Done - 2. Create yourself a virtual environment.
Done - 3. Install all of the packages listed in requirements.txt (Visual Studio will
